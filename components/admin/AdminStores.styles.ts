...
export const adminStoresStyles = StyleSheet.create({
  ...
  sectionActionsRow: { flexDirection: 'row-reverse', alignItems: 'center', gap: 8, maxWidth: '64%' },
  ...
  filterBtnText: { color: '#075985', fontSize: 13, fontWeight: '700' },
  filterBtnTextActive: { color: '#0C4A6E' },
  ...
  filterModalOptionTextActive: { color: '#075985' },
  filterModalCloseBtn: {
    marginTop: 8,
    borderRadius: 10,
    backgroundColor: '#F3F4F6',
  ...
  filterModalCloseBtnText: { color: '#475569', fontWeight: '700', fontSize: 14 },
});
